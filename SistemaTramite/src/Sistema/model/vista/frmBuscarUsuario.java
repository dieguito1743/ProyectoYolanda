...
public class frmBuscarUsuario extends javax.swing.JDialog {
    ...
    frmBuscarUsuario(frmPermisos aThis, boolean b) {
        super(aThis, b);
        initComponents();
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        try {
            TableColumn columna;
            docTableModel = UsuarioBo.obtenerListaUsuariosBuscar(txtUsuario.getText());
    ...
    private void tblPermisoMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblPermisoMousePressed
        if (evt.getClickCount() == 2) {
            ...
            permiso.getTxtUsuario().setText(tblPermiso.getValueAt(index, 1).toString());
            permiso.getTxtIdUsuario().setText(tblPermiso.getValueAt(index, 0).toString());
            this.dispose();
        }
