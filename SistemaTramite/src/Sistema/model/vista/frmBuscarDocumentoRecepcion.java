...
public class frmBuscarDocumentoRecepcion extends javax.swing.JDialog {
    ...
    private void btnBuscarRecepcionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarRecepcionActionPerformed
        try {
            ...
            //aqui
            String titu[] = {"COD", "REMITENTE","CARGO", "INSTITUCION","DOCUMENTO","FECHA","HORA","RESPONSABLE","CODREMITENTE","ASUNTO","REFERENCIA","DESTINATARIO",};
    ...
    private void tblDocumentoRecepcionMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblDocumentoRecepcionMouseClicked
        if (evt.getClickCount() >= 2) {
            ...
            recepcion.getTxtcodigoRecepcion().setText(tblDocumentoRecepcion.getValueAt(index, 0).toString());
      //    recepcion.getTxtRemitenteRecepcion().setText(tblDocumentoRecepcion.getValueAt(index, 1).toString());
//            recepcion.getTxtCargoRecepcion().setText(tblDocumentoRecepcion.getValueAt(index, 2).toString());
            recepcion.getTxtinstitucionRecepcion().setText(tblDocumentoRecepcion.getValueAt(index, 3).toString());
            recepcion.getTxtDocumentoRecepcion().setText(tblDocumentoRecepcion.getValueAt(index, 4).toString());
//          recepcion.gettxtfechaRecepcion().setText(tblDocumentoRecepcion.getValueAt(index, 5).toString());
//          recepcion.gettxtHoraRecepcion().setText(tblDocumentoRecepcion.getValueAt(index, 6).toString());
    //      recepcion.getTxtRRecepcion().setText(tblDocumentoRecepcion.getValueAt(index, 7).toString());
   //        recepcion.getTxtcodRemRecepcion().setText(tblDocumentoRecepcion.getValueAt(index, 8).toString());
//            recepcion.getTxtAsuntoRecepcion().setText(tblDocumentoRecepcion.getValueAt(index, 9).toString());
       //   recepcion.getTxtReferenciaRecepcion().setText(tblDocumentoRecepcion.getValueAt(index, 10).toString());
            recepcion.getTxtDestinatarioRecepcion().setText(tblDocumentoRecepcion.getValueAt(index, 11).toString());
            this.dispose();
        }
